...
class EventAdapter(private val list: List<DomainEventDTO>, private val listener: (item: DomainEventDTO) -> Unit): RecyclerView.Adapter<EventAdapter.EventViewHolder>() {
